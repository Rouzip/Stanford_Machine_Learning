...
if __name__ == '__main__':
    ...
    # part5 learn curve for linear regression
    Xval = data['Xval']
    ...
    # part7 learn curve for ploynomial regression
    lambda_ = 0
    ...
    # part9 compute test set error on the best lambda
    lambda_val = 3
    ...
    # part10 plot learning curves with randomly selected example
    lambda_val = 0.01
    times = 50
